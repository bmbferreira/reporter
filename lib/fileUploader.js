...
const fileData = fs.readFileSync(filePath);
  ...
  try {
    ...
    console.log('here1');
    console.log(out.singleUploadResult.Location);
    console.log('here11');
    console.log(response)
    // if (response.singleUploadResult.Location) is undefined
    if (response.singleUploadResult.Location === undefined) {
      return response.Location;
    }
    return response.singleUploadResult.Location;
  } catch (e) {
    console.log('here2');
    console.log(e);
    console.log(e.stack);
